...
sed -i 's/GRUB_CMDLINE_LINUX_DEFAULT="loglevel=3 quite"/GRUB_CMDLINE_LINUX_DEFAULT="cryptdeice=\/dev\/${ROOT}:${VOLGRP}:allow-discards loglevel=3"/g' /etc/default/grub
